...
const AMAZON_PRODUCTS = [
  ...
  { asin: '0553380990', name: 'Radical Acceptance', tags: ['acceptance','self-compassion','buddhism'], sentence: "Tara Brach's <a href=\"URL\" target=\"_blank\" rel=\"nofollow sponsored\">Radical Acceptance</a> (paid link) taught me that the opposite of resistance isn't giving up." },
  ...
  { asin: 'B0C6VQ4XZM', name: 'Tibetan Singing Bowl Set', tags: ['singing-bowl','meditation','sound','vibration'], sentence: "I started using a <a href=\"URL\" target=\"_blank\" rel=\"nofollow sponsored\">Tibetan Singing Bowl</a> (paid link) during my own forgiveness practice." },
  { asin: 'B073VSFGCL', name: 'Weighted Blanket', tags: ['weighted-blanket','anxiety','nervous-system','sleep'], sentence: "A <a href=\"URL\" target=\"_blank\" rel=\"nofollow sponsored\">Weighted Blanket</a> (paid link) provides deep pressure stimulation that calms an activated nervous system." },
