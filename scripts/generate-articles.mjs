...
const PRODUCT_CATALOG = [
  ...
  { asin: '0553380990', name: 'Radical Acceptance', tags: ['acceptance','self-compassion','buddhism','meditation'], sentence: "Tara Brach's <a href=\"URL\" target=\"_blank\" rel=\"nofollow sponsored\">Radical Acceptance</a> (paid link) taught me that the opposite of resistance isn't giving up - it's showing up with your whole heart." },
  ...
  { asin: '1611803438', name: 'What Happened to You', tags: ['trauma','childhood','brain','resilience','connection'], sentence: "I keep coming back to <a href=\"URL\" target=\"_blank\" rel=\"nofollow sponsored\">What Happened to You</a> (paid link) - it shifts the question from 'what's wrong with you' to 'what happened to you.'" },
  ...
  { asin: 'B0DHCHK1G6', name: 'Meditation Cushion', tags: ['meditation','cushion','sitting','practice','posture'], sentence: "A decent <a href=\"URL\" target=\"_blank\" rel=\"nofollow sponsored\">Meditation Cushion</a> (paid link) makes a real difference - the body needs support when you ask it to be still with difficult material." },
  { asin: 'B0DHSRL27S', name: 'Theragun Mini', tags: ['massage','tension','body','release','muscle'], sentence: "A <a href=\"URL\" target=\"_blank\" rel=\"nofollow sponsored\">Theragun Mini</a> (paid link) targets the specific muscle tension that often accompanies unresolved resentment - jaw, shoulders, hips especially." },
  { asin: 'B073VSFGCL', name: 'Weighted Blanket', tags: ['weighted-blanket','anxiety','nervous-system','sleep','grounding'], sentence: "A <a href=\"URL\" target=\"_blank\" rel=\"nofollow sponsored\">Weighted Blanket</a> (paid link) provides deep pressure stimulation that calms an activated nervous system - it's like a hug that doesn't ask anything of you." },
  { asin: 'B095KMHYHP', name: 'Essential Oil Diffuser', tags: ['diffuser','essential-oils','atmosphere','calm','ritual'], sentence: "An <a href=\"URL\" target=\"_blank\" rel=\"nofollow sponsored\">Essential Oil Diffuser</a> (paid link) can anchor your practice in a specific sensory experience - the body remembers scent faster than it remembers words." },
  { asin: 'B0C6VQ4XZM', name: 'Magnesium Glycinate', tags: ['magnesium','sleep','nervous-system','calm','supplement'], sentence: "<a href=\"URL\" target=\"_blank\" rel=\"nofollow sponsored\">Magnesium Glycinate</a> (paid link) supports nervous system regulation and the kind of deep sleep that chronic resentment tends to steal." },
  { asin: '0143127748', name: 'The Forgiveness Workbook', tags: ['forgiveness','workbook','exercises','writing','practice'], sentence: "If you prefer working things out on paper, <a href=\"URL\" target=\"_blank\" rel=\"nofollow sponsored\">The Forgiveness Workbook</a> (paid link) gives you guided exercises that take this from theory to practice." },
  { asin: 'B0841XL2WV', name: 'Shadow Work Journal', tags: ['shadow','inner-work','journaling','unconscious','self-discovery'], sentence: "A <a href=\"URL\" target=\"_blank\" rel=\"nofollow sponsored\">Shadow Work Journal</a> (paid link) is designed for exactly this kind of exploration - the parts of yourself you tend to avoid are usually the ones holding the resentment." },
  { asin: 'B095KMHYHP', name: 'Breathing Exercise Device', tags: ['breathwork','breathing','nervous-system','regulation','vagus'], sentence: "A <a href=\"URL\" target=\"_blank\" rel=\"nofollow sponsored\">Breathing Exercise Device</a> (paid link) guides your exhale to activate the vagus nerve - it's a physical tool for something that feels entirely internal." },
  { asin: 'B07Q86KDVJ', name: 'Grounding Mat', tags: ['grounding','earthing','body','nature','nervous-system'], sentence: "A <a href=\"URL\" target=\"_blank\" rel=\"nofollow sponsored\">Grounding Mat</a> (paid link) brings the calming effects of earth contact indoors - your nervous system responds to it whether your mind believes in it or not." },
];
