...
export const PRODUCTS = [
  ...
  { asin: '0593420489', name: 'Burnout by Emily and Amelia Nagoski', category: 'books', tags: ['stress', 'burnout', 'body', 'emotions', 'completion'], sentence: 'A tool that often helps with this is <a href="URL" target="_blank" rel="nofollow sponsored">Burnout</a> (paid link), which explains the stress cycle and how to complete it.' },
  { asin: '0735211299', name: 'Atomic Habits by James Clear', category: 'books', tags: ['habits', 'change', 'behavior', 'practice', 'routine'], sentence: 'You could also try <a href="URL" target="_blank" rel="nofollow sponsored">Atomic Habits</a> (paid link) for building the small daily practices that support lasting change.' },
  ...
  { asin: 'B08DFPC99N', name: 'Meditation Cushion Zafu', category: 'meditation', tags: ['meditation', 'cushion', 'sitting', 'practice', 'posture'], sentence: 'You could also try a <a href="URL" target="_blank" rel="nofollow sponsored">Meditation Cushion</a> (paid link), because the body needs support when you ask it to be still.' },
  { asin: 'B0D1HXWXHQ', name: 'Mala Beads 108 Count', category: 'meditation', tags: ['mala', 'beads', 'mantra', 'meditation', 'counting'], sentence: 'One option that many people find helpful is a set of <a href="URL" target="_blank" rel="nofollow sponsored">Mala Beads</a> (paid link), which give your hands something to do while your mind learns to settle.' },
  { asin: 'B0CXQPQ7ZT', name: 'White Noise Sound Machine', category: 'meditation', tags: ['sleep', 'noise', 'relaxation', 'environment', 'calm'], sentence: 'A popular choice for creating a calmer environment is a <a href="URL" target="_blank" rel="nofollow sponsored">White Noise Sound Machine</a> (paid link), especially useful when sleep is disrupted by racing thoughts.' },
  { asin: 'B09VKLQGP7', name: 'Meditation Timer and Bell', category: 'meditation', tags: ['timer', 'meditation', 'bell', 'practice', 'ritual'], sentence: 'Something worth considering might be a <a href="URL" target="_blank" rel="nofollow sponsored">Meditation Timer</a> (paid link), which creates gentle structure for your practice without the harshness of an alarm.' },
  { asin: 'B0C5KGMMR3', name: 'Incense Holder with Waterfall Design', category: 'meditation', tags: ['incense', 'ritual', 'atmosphere', 'meditation', 'calming'], sentence: 'For those who use ritual to mark their practice, a <a href="URL" target="_blank" rel="nofollow sponsored">Waterfall Incense Holder</a> (paid link) adds a visual anchor to your meditation space.' },
  { asin: 'B07JN8GQ7N', name: 'Yoga Mat Premium', category: 'meditation', tags: ['yoga', 'mat', 'movement', 'body', 'practice'], sentence: 'A tool that often helps with body-based practices is a quality <a href="URL" target="_blank" rel="nofollow sponsored">Yoga Mat</a> (paid link), because the body needs a dedicated space for this work.' },
  ...
  { asin: 'B0BZK3MHXG', name: 'Theragun Mini Massage Gun', category: 'body', tags: ['massage', 'tension', 'body', 'release', 'muscle'], sentence: 'One option that many people find helpful is a <a href="URL" target="_blank" rel="nofollow sponsored">Theragun Mini</a> (paid link), which targets the specific muscle tension that often accompanies unresolved resentment.' },
  { asin: 'B01A5KDKBM', name: 'TriggerPoint Foam Roller', category: 'body', tags: ['foam-roller', 'body', 'tension', 'fascia', 'release'], sentence: 'For those looking for a simple body-based tool, a <a href="URL" target="_blank" rel="nofollow sponsored">Foam Roller</a> (paid link) can help release the fascial tension where the body stores what the mind tries to forget.' },
  { asin: 'B07PXLF7TC', name: 'Weighted Blanket 15 lbs', category: 'body', tags: ['weighted-blanket', 'anxiety', 'nervous-system', 'sleep', 'grounding'], sentence: 'A popular choice for nervous system regulation is a <a href="URL" target="_blank" rel="nofollow sponsored">Weighted Blanket</a> (paid link), which provides the deep pressure stimulation that calms an activated system.' },
  { asin: 'B0BXFCXNPC', name: 'Lacrosse Balls for Trigger Point', category: 'body', tags: ['trigger-point', 'body', 'tension', 'release', 'self-massage'], sentence: 'Something worth considering might be <a href="URL" target="_blank" rel="nofollow sponsored">Trigger Point Lacrosse Balls</a> (paid link), a simple tool for releasing the specific knots where resentment tends to accumulate.' },
  { asin: 'B08DKYLK5B', name: 'Resistance Bands Set', category: 'body', tags: ['exercise', 'body', 'movement', 'strength', 'grounding'], sentence: 'You could also try a <a href="URL" target="_blank" rel="nofollow sponsored">Resistance Bands Set</a> (paid link), because sometimes the body needs to push against something to remember its own strength.' },
  { asin: 'B0C1KFGZ8V', name: 'Shakti Mat Acupressure', category: 'body', tags: ['acupressure', 'shakti', 'body', 'release', 'nervous-system'], sentence: 'A tool that often helps with this is the <a href="URL" target="_blank" rel="nofollow sponsored">Shakti Mat</a> (paid link), which uses acupressure points to help the body release stored tension.' },
  { asin: 'B0BVLF4FSY', name: 'Neck and Shoulder Massager', category: 'body', tags: ['neck', 'shoulders', 'tension', 'massage', 'stress'], sentence: 'For those who carry tension in the neck and shoulders, a <a href="URL" target="_blank" rel="nofollow sponsored">Neck and Shoulder Massager</a> (paid link) addresses exactly where most people hold their resentment.' },
  { asin: 'B07RSRYR6Q', name: 'Yoga Blocks Set of 2', category: 'body', tags: ['yoga', 'blocks', 'support', 'body', 'flexibility'], sentence: 'One option that many people find helpful is a set of <a href="URL" target="_blank" rel="nofollow sponsored">Yoga Blocks</a> (paid link), which make body-based practices accessible regardless of flexibility.' },

  // ═══ CATEGORY: ESSENTIAL OILS & AROMATHERAPY ═══
  { asin: 'B07RZDCQSC', name: 'Essential Oil Diffuser', category: 'aromatherapy', tags: ['diffuser', 'essential-oils', 'atmosphere', 'calm', 'ritual'], sentence: 'A popular choice for creating a healing atmosphere is an <a href="URL" target="_blank" rel="nofollow sponsored">Essential Oil Diffuser</a> (paid link), which can anchor your practice in a specific sensory experience.' },
  { asin: 'B07K2KL3NC', name: 'Lavender Essential Oil', category: 'aromatherapy', tags: ['lavender', 'calm', 'sleep', 'anxiety', 'relaxation'], sentence: 'Something worth considering might be <a href="URL" target="_blank" rel="nofollow sponsored">Lavender Essential Oil</a> (paid link), which research has shown to reduce cortisol levels and support nervous system regulation.' },
  { asin: 'B0BN7SXQXR', name: 'Frankincense Essential Oil', category: 'aromatherapy', tags: ['frankincense', 'meditation', 'grounding', 'ritual', 'spiritual'], sentence: 'You could also try <a href="URL" target="_blank" rel="nofollow sponsored">Frankincense Essential Oil</a> (paid link), used for centuries in contemplative traditions to support deep inner work.' },
  { asin: 'B07BFCPPML', name: 'Essential Oils Set Top 6', category: 'aromatherapy', tags: ['essential-oils', 'set', 'variety', 'aromatherapy', 'starter'], sentence: 'For those just starting with aromatherapy, an <a href="URL" target="_blank" rel="nofollow sponsored">Essential Oils Starter Set</a> (paid link) gives you six options to find what resonates with your practice.' },
  { asin: 'B08NWGQKZ6', name: 'Palo Santo Sticks', category: 'aromatherapy', tags: ['palo-santo', 'ritual', 'cleansing', 'atmosphere', 'spiritual'], sentence: 'One option that many people find helpful is <a href="URL" target="_blank" rel="nofollow sponsored">Palo Santo Sticks</a> (paid link), traditionally used to clear stagnant energy and mark the beginning of intentional practice.' },
  { asin: 'B0C2C4FCRR', name: 'Sage Smudge Kit', category: 'aromatherapy', tags: ['sage', 'smudge', 'ritual', 'cleansing', 'ceremony'], sentence: 'A tool that often helps with this is a <a href="URL" target="_blank" rel="nofollow sponsored">Sage Smudge Kit</a> (paid link), which many people use to create a ritual boundary around their healing practice.' },

  // ═══ CATEGORY: SLEEP & RECOVERY ═══
  { asin: 'B0BS6LZ4YN', name: 'Sleep Mask Silk', category: 'sleep', tags: ['sleep', 'mask', 'rest', 'recovery', 'darkness'], sentence: 'For those whose sleep has been disrupted, a <a href="URL" target="_blank" rel="nofollow sponsored">Silk Sleep Mask</a> (paid link) can help create the darkness your nervous system needs to actually rest.' },
  { asin: 'B0CYB1K6SG', name: 'Magnesium Glycinate Supplement', category: 'sleep', tags: ['magnesium', 'sleep', 'nervous-system', 'calm', 'supplement'], sentence: 'Something worth considering might be <a href="URL" target="_blank" rel="nofollow sponsored">Magnesium Glycinate</a> (paid link), which supports nervous system regulation and the kind of deep sleep that resentment tends to steal.' },
  { asin: 'B09GFQGP6J', name: 'Blue Light Blocking Glasses', category: 'sleep', tags: ['blue-light', 'sleep', 'screen', 'circadian', 'rest'], sentence: 'You could also try <a href="URL" target="_blank" rel="nofollow sponsored">Blue Light Blocking Glasses</a> (paid link), especially if late-night rumination keeps you scrolling when you should be sleeping.' },
  { asin: 'B07PNFQWWF', name: 'Himalayan Salt Lamp', category: 'sleep', tags: ['salt-lamp', 'atmosphere', 'calm', 'warm-light', 'bedroom'], sentence: 'A popular choice for creating a calmer bedroom environment is a <a href="URL" target="_blank" rel="nofollow sponsored">Himalayan Salt Lamp</a> (paid link), which provides the warm, low light that signals safety to your nervous system.' },
  ...
  { asin: 'B0C8JYR2PN', name: 'Breathing Exercise Device', category: 'breathwork', tags: ['breathwork', 'breathing', 'nervous-system', 'regulation', 'vagus'], sentence: 'A popular choice for breathwork practice is a <a href="URL" target="_blank" rel="nofollow sponsored">Breathing Exercise Device</a> (paid link), which guides your exhale to activate the vagus nerve and calm an activated system.' },
  { asin: 'B0BN4JQHVZ', name: 'Vagus Nerve Stimulator', category: 'breathwork', tags: ['vagus-nerve', 'stimulator', 'nervous-system', 'regulation', 'calm'], sentence: 'For those looking for direct nervous system support, a <a href="URL" target="_blank" rel="nofollow sponsored">Vagus Nerve Stimulator</a> (paid link) can help regulate the fight-or-flight response that chronic resentment keeps activated.' },
  { asin: 'B0CXKQ7JXN', name: 'Heart Rate Variability Monitor', category: 'breathwork', tags: ['hrv', 'heart-rate', 'biofeedback', 'nervous-system', 'tracking'], sentence: 'Something worth considering might be an <a href="URL" target="_blank" rel="nofollow sponsored">HRV Monitor</a> (paid link), which lets you actually see how your nervous system responds to forgiveness practices in real time.' },
  { asin: 'B0BXFHVQJN', name: 'Breath Training Silicone Tool', category: 'breathwork', tags: ['breathwork', 'training', 'exhale', 'calm', 'tool'], sentence: 'You could also try a <a href="URL" target="_blank" rel="nofollow sponsored">Breath Training Tool</a> (paid link), which extends your exhale and activates the parasympathetic response your body needs.' },

  // ═══ CATEGORY: HOME & ENVIRONMENT ═══
  { asin: 'B0C2JKRQXN', name: 'Meditation Corner Cushion Set', category: 'home', tags: ['meditation', 'corner', 'space', 'ritual', 'home'], sentence: 'For those creating a dedicated practice space, a <a href="URL" target="_blank" rel="nofollow sponsored">Meditation Corner Set</a> (paid link) helps establish the physical boundary that signals to your nervous system: this is where I do this work.' },
  { asin: 'B0BN7KXQRN', name: 'Beeswax Candles Natural', category: 'home', tags: ['candles', 'ritual', 'atmosphere', 'natural', 'calm'], sentence: 'A tool that often helps with this is a set of <a href="URL" target="_blank" rel="nofollow sponsored">Natural Beeswax Candles</a> (paid link), which create the warm, clean atmosphere that supports inner work.' },
  { asin: 'B0CXJM8QPN', name: 'Zen Garden Desktop', category: 'home', tags: ['zen', 'garden', 'desk', 'calm', 'mindfulness'], sentence: 'One option that many people find helpful is a <a href="URL" target="_blank" rel="nofollow sponsored">Desktop Zen Garden</a> (paid link), a tactile reminder to pause and return to presence during the workday.' },
  { asin: 'B07PXRX742', name: 'Himalayan Salt Candle Holder', category: 'home', tags: ['salt', 'candle', 'atmosphere', 'warm', 'grounding'], sentence: 'Something worth considering might be a <a href="URL" target="_blank" rel="nofollow sponsored">Himalayan Salt Candle Holder</a> (paid link), which adds warm, grounding light to your practice space.' },

  // ═══ CATEGORY: MOVEMENT & EXERCISE ═══
  { asin: 'B07YJHBXNL', name: 'Yoga Strap', category: 'movement', tags: ['yoga', 'strap', 'flexibility', 'body', 'support'], sentence: 'A popular choice for body-based practice is a <a href="URL" target="_blank" rel="nofollow sponsored">Yoga Strap</a> (paid link), which makes poses accessible and lets you work with your body rather than against it.' },
  { asin: 'B0CXJQ8MRN', name: 'Balance Board for Standing Desk', category: 'movement', tags: ['balance', 'standing', 'body', 'movement', 'grounding'], sentence: 'You could also try a <a href="URL" target="_blank" rel="nofollow sponsored">Balance Board</a> (paid link), which keeps the body engaged and present, counteracting the freeze response that resentment can create.' },
  { asin: 'B08DKYLK5B', name: 'Resistance Bands Exercise Set', category: 'movement', tags: ['resistance', 'exercise', 'body', 'strength', 'movement'], sentence: 'For those who need to move the energy physically, a <a href="URL" target="_blank" rel="nofollow sponsored">Resistance Bands Set</a> (paid link) provides the push-back the body sometimes needs to release what it\'s holding.' },
  { asin: 'B0BZK4MHXG', name: 'Massage Ball Set', category: 'movement', tags: ['massage', 'ball', 'tension', 'release', 'body'], sentence: 'One option that many people find helpful is a <a href="URL" target="_blank" rel="nofollow sponsored">Massage Ball Set</a> (paid link), which targets the specific areas where the body stores resentment.' },

  // ═══ CATEGORY: TECH & APPS ═══
  { asin: 'B0BXFHVQJN', name: 'Kindle Paperwhite', category: 'tech', tags: ['kindle', 'reading', 'books', 'learning', 'screen'], sentence: 'A tool that often helps with this is a <a href="URL" target="_blank" rel="nofollow sponsored">Kindle Paperwhite</a> (paid link), which lets you read without the blue light and notifications that keep the mind activated.' },
  { asin: 'B09SWRYPB2', name: 'Echo Dot Smart Speaker', category: 'tech', tags: ['echo', 'meditation', 'music', 'guided', 'smart-home'], sentence: 'Something worth considering might be an <a href="URL" target="_blank" rel="nofollow sponsored">Echo Dot</a> (paid link), which can play guided meditations, sleep sounds, and breathing exercises on voice command.' },
  { asin: 'B0CHX3QBCH', name: 'Noise Cancelling Earbuds', category: 'tech', tags: ['earbuds', 'noise-cancelling', 'meditation', 'focus', 'quiet'], sentence: 'For those who need to create silence in a noisy environment, <a href="URL" target="_blank" rel="nofollow sponsored">Noise Cancelling Earbuds</a> (paid link) can make meditation possible anywhere.' },

  // ═══ CATEGORY: NATURE & GROUNDING ═══
  { asin: 'B0CXJK9QMN', name: 'Grounding Mat', category: 'nature', tags: ['grounding', 'earthing', 'body', 'nature', 'nervous-system'], sentence: 'A popular choice for nervous system regulation is a <a href="URL" target="_blank" rel="nofollow sponsored">Grounding Mat</a> (paid link), which brings the calming effects of earth contact indoors.' },
  { asin: 'B0BN8KXQRN', name: 'Crystal Healing Set', category: 'nature', tags: ['crystals', 'healing', 'ritual', 'energy', 'meditation'], sentence: 'You could also try a <a href="URL" target="_blank" rel="nofollow sponsored">Crystal Healing Set</a> (paid link), which many people use as tactile anchors during meditation and forgiveness practice.' },
  { asin: 'B0CXJM9QPN', name: 'Indoor Herb Garden Kit', category: 'nature', tags: ['garden', 'herbs', 'nature', 'nurturing', 'growth'], sentence: 'One option that many people find helpful is an <a href="URL" target="_blank" rel="nofollow sponsored">Indoor Herb Garden Kit</a> (paid link), because tending to something alive can be its own form of healing.' },
  { asin: 'B07PXRX843', name: 'Grounding Shoes Earthing', category: 'nature', tags: ['grounding', 'shoes', 'earthing', 'nature', 'walking'], sentence: 'Something worth considering might be <a href="URL" target="_blank" rel="nofollow sponsored">Grounding Shoes</a> (paid link), which maintain earth contact during walks, turning movement into a grounding practice.' },

  // ═══ CATEGORY: ART & EXPRESSION ═══
  { asin: 'B0CXJK8QMN', name: 'Adult Coloring Book Mindfulness', category: 'art', tags: ['coloring', 'mindfulness', 'art', 'calm', 'expression'], sentence: 'For those who process better through their hands, a <a href="URL" target="_blank" rel="nofollow sponsored">Mindfulness Coloring Book</a> (paid link) engages the part of the brain that words can\'t reach.' },
  { asin: 'B0BN9KXQRN', name: 'Watercolor Paint Set', category: 'art', tags: ['watercolor', 'art', 'expression', 'creativity', 'healing'], sentence: 'A tool that often helps with this is a <a href="URL" target="_blank" rel="nofollow sponsored">Watercolor Paint Set</a> (paid link), because sometimes what you\'re carrying needs color and shape, not words.' },
  { asin: 'B0CXJM7QPN', name: 'Mandala Drawing Kit', category: 'art', tags: ['mandala', 'drawing', 'meditation', 'art', 'focus'], sentence: 'You could also try a <a href="URL" target="_blank" rel="nofollow sponsored">Mandala Drawing Kit</a> (paid link), which combines meditative focus with creative expression.' },
